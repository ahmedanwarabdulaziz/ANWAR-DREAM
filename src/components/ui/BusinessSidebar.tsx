...
const navItems = [
  ...
  { href: '/business/classes', label: 'Customer Classes' },
  { href: '/business/settings', label: 'Settings' },
];

export default function BusinessSidebar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Mobile top bar (matches admin style) */}
      <div className="md:hidden sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-gray200">
        <div className="px-4 h-14 flex items-center justify-between">
          ...
          <div className="text-primary font-bold">Business</div>
          <div className="w-6" />
        </div>
      </div>
      ...
      <div className="flex">
        ...
        <aside className="hidden md:flex md:flex-col md:w-64 border-r border-gray200 min-h-screen sticky top-0">
          <div className="h-16 flex items-center px-4 text-primary font-bold">Business</div>
