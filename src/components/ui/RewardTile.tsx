  ...
  ({ 
    ...
    return (
      <div
        ref={ref}
        className={clsx(
          'bg-white rounded-xl p-6 cursor-pointer transition-all duration-normal hover:scale-[1.02] hover:shadow-lg group border border-gray200',
      ...
      >
        {imageUrl && (
          <div className="aspect-video bg-gray100 rounded-lg mb-4 overflow-hidden">
            <img
              src={imageUrl}
              alt={title}
        ...
        <div className="space-y-2">
          ...
          <p className="text-caption text-gray600">{description}</p>
